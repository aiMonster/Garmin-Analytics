export class DateUtils {
  /** Collection of Months labels like JAN, FEB, etc. */
  public static readonly MonthsList = Object.freeze([
    'JAN',
    'FEB',
    'MAR',
    'APR',
  ...
  /** Collection of Months labels like January, February, etc. */
  public static readonly MonthsFullList = Object.freeze([
    'January',
    'February',
    'March',
    'April',
  ...
  /**
   * Converts full date and time to string
   *
   * @param date input date
   * @returns date in format YYYY-MM-DD HH:MM:SS
   */
  public static convertFull(date: Date): string {
    const parts = date.toJSON().split('T');
    return `${parts[0]} ${parts[1].split('.')[0]}`;
  }
  /**
   * Retrieves only date from YYYY-MM-DD HH:MM:SS
   * @param date input date
   * @returns date in format YYYY-MM-DD
   */
